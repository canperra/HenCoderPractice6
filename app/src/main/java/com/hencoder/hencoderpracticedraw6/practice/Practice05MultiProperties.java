    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!show) {
                    imageView.animate().rotation(360).scaleX(1)
                            .scaleY(1).alpha(1).translationX(Utils.dpToPixel(200));
                    show = true;
                } else {
                    imageView.animate().rotation(0).scaleY(0).scaleX(0).alpha(0).translationX(0);
                    show = false;
                }
            }
        });
